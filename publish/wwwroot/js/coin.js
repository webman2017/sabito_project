function initparticles() {
 ...
 function bubbles() {
    $.each($(".particletext.bubbles"), function(){
       var bubblecount = ($(this).width()/50)*100;
       for(var i = 0; i <= 6; i++) {
          var size = ($.rnd(40,80)/10);
          $(this).append('<span class="particle" style="top:' + $.rnd(-10,0) + '%; left:' + $.rnd(-10,100) + '%;width: 10px; height:20px;animation-delay: ' + ($.rnd(0,30)/10) + 's;"></span>');
       }
    });
 }
