...
{
    public class StockandOrganizeController : Controller
    {
        private readonly MvcMovieContext _context;

        public StockandOrganizeController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
           ...
           return View(await _context.StockandOrganize.ToListAsync());
        }
